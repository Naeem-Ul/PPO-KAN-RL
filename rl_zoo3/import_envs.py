...
# try:
#     from half_cheetah_image_env import HalfCheetahImageEnv
# except ImportError:
#     pass
...
# Register HalfCheetahImageEnv
register(
    id="HalfCheetahImage-v0",
    entry_point="custom_envs.half_cheetah_image_env:HalfCheetahImageEnv",
)

#Register HalfCheetahObservationAndImageEnv
register(
    id="HalfCheetahObservationAndImage-v0",
    entry_point="custom_envs.half_cheetah_image_env:HalfCheetahObservationAndImageEnv",
)